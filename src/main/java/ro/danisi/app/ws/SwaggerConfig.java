...
public class SwaggerConfig {
	...
	Contact contact = new Contact("Sergey Kargopolov", "http://www.appsdeveloperblog.com",
	...
	ApiInfo apiInfo = new ApiInfo("Photo app RESTful Web Service documentation",
			...
			"http://www.appsdeveloperblog.com/service.html", contact, "Apache 2.0",
	...
	public Docket apiDocket() {
		...
		Docket docket = new Docket(DocumentationType.SWAGGER_2).protocols(new HashSet<>(Arrays.asList("HTTP", "HTTPs")))
				.apiInfo(apiInfo).select().apis(RequestHandlerSelectors.basePackage("ro.danisi.app.ws"))
