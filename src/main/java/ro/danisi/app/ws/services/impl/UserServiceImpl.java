...
import ro.danisi.app.ws.io.repositories.PasswordResetTokenRepository;
import ro.danisi.app.ws.io.repositories.UserRepository;
import ro.danisi.app.ws.services.UserService;
import ro.danisi.app.ws.shared.AmazonSES;
...
//		amazonSES.verifyEmail(returnValue);
	...
	public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
		...
		userEntity.setEmailVerificationStatus(true); //sterge cand implementezi functionalitatea de verificare email
